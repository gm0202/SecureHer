...
class _SafeHomeState extends State<SafeHome> {
  ...
  Future<bool> _handleLocationPermission() async {
    ...
    if (!serviceEnabled) {
      toastification.show(
        context: context,
        title: const Text('Location services are disabled. Please enable the services'),
    ...
    if (permission == LocationPermission.deniedForever) {
      toastification.show(
        context: context,
        title: const Text('Location permissions are permanently denied, we cannot request permissions.'),
        autoCloseDuration: const Duration(seconds: 3),
      );
      return false;
    }
  ...
  void _shareLocation() {
    ...
    locationMessage += "https://www.google.com/maps/search/?api=1&query=${_currentPosition!.latitude}%2C${_currentPosition!.longitude}\n\n";
